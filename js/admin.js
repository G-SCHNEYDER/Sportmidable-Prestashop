...
$(document).ready(function() {
  ...
  const elem =document.getElementById("subtab-AdminParentCreativeElements");
  const shop_list=document.getElementById("shop-list");
  shop_name=shop_list.getElementsByClassName("selected-item")[0].innerText;
//  console.log(shop_name);
  if(shop_name.indexOf("All shops")!== -1){
