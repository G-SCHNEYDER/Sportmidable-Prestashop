	...
	<tr>
		<td style="text-align: center; font-size: 6pt; color: #444;  width:100%;">
			{if $available_in_your_account}
				...
				<br />
			{/if}
			<div style="margin:0 30px; display:inline">
				FRANCE : 2, rue Willy Brandt - 25300 PONTARLIER +33 3 74 47 30 72 / SUISSE : Chemin de la Lentillères 13C - 1023 CRISSIER +41 21 561 36 84
			</div>
