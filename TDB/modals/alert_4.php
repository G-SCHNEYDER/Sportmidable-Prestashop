<!-- Alerts Modal -->
<div class="modal fade" id="alert-4-Modal" role="dialog">
    <div class="modal-dialog modal-xl">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Alertes Reliquat</h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id='print-alert-4'>Imprimer</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
    <!-- Image loader -->
    <div id='alert-4-loader' class="loader" style='display: none;'>
