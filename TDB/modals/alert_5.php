<!-- Alerts Modal -->
<div class="modal fade" id="alert-5-Modal" role="dialog">
    <div class="modal-dialog modal-xl">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Alertes Reçu</h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id='print-alert-5'>Imprimer</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
    <!-- Image loader -->
    <div id='alert-5-loader' class="loader" style='display: none;'>
