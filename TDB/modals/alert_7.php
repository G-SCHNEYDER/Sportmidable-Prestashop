<!-- Alerts Modal -->
<div class="modal fade" id="alert-7-Modal" role="dialog">
    <div class="modal-dialog modal-xl">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Alertes Expédition</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="alerts-modal-body">
                <?php if (count($alerts[7])) : ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id='print-alert-7'>Imprimer</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
    <!-- Image loader -->
    <div id='alert-7-loader' class="loader" style='display: none;'>
