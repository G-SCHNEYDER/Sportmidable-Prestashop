			...
			<div class="cart-voucher">
				...
				<p class="promo-code-button display-promo{if $cart.discounts|count > 0} with-discounts{/if}">
					<a class="collapse-button" href="#promo-code">
                        {l s='Do you have a promo code or a gift card ?' d='Shop.Theme.Checkout'}
					</a>
				</p>
					...
					<div class="promo-code">
                        {block name='cart_voucher_form'}
							<form action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
								...
								<input class="promo-input" type="text" name="discount_name" placeholder="{l s='promo code / gift card' d='Shop.Theme.Checkout'}">
						...
						<a class="collapse-button promo-code-button cancel-promo" role="button" data-toggle="collapse" data-target="#promo-code"
