...
{block name='content'}
  <section id="main" class='container pack' itemscope itemtype="https://schema.org/Product">
        ...
        {block name='page_header_container'}
          ...
          <div class='titreetprix'>
            ...
            {if $product.description_short}
              <div class="resume" itemprop="description">{$product.description_short nofilter}</div>
            {/if}
